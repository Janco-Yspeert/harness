...
Revision 001 — initial frozen suite, archived unchanged after E3's unavailable-
executor fixture was found to retain the fixture executable on `PATH`.

Revision 002 — corrected E3 to use a PATH containing no executable. The exact
revision 001 bundle and freeze metadata are preserved under `.eval/revisions/001`.
